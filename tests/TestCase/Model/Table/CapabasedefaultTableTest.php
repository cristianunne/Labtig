...
class CapabasedefaultTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('Capabasedefault') ? [] : ['className' => CapabasedefaultTable::class];
        $this->Capabasedefault = TableRegistry::getTableLocator()->get('Capabasedefault', $config);
    }
