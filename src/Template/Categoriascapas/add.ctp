...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <?= $this->Form->create($categoriascapas) ?>
            ...
            <div class="col-md-4" style="float: none; margin: 0 auto">
                ...
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">Agregar Categorías Temáticas de Capas</h3>
                    </div>
                    <div class="box-body">
                    ...
                    <div class="box-footer">
                        ...
                        <?= $this->Html->link('Volver', ['controller' => 'Categoriascapas', 'action' => 'index', '?' => ['Accion' => 'Ver Categorìas Temàticas de Capas Base', 'Categoria' => 'CatCapas']],
